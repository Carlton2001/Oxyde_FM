...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::session::split_panel,
            commands::session::add_panel,
            commands::session::remove_panel,
            commands::session::clear_all_panels_except,
            commands::session::set_active_panel,
            commands::session::update_sort_config,
            commands::session::swap_panels,
            commands::session::update_layout_weights,
            // Config Commands
